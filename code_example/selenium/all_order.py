...
class AllOrder:
    ...
    def report(self):
        ...
        driver.find_element_by_xpath("//*[@id='FlatFileAllOrdersReport']/a").click()
        time.sleep(3)
        driver.find_element_by_xpaht("//*[@id='downloadReportForm']/table/tbody/tr[4]/td[2]/button/span").click()
        time.sleep(200)
